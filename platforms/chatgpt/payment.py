...
CTF_RELAY_CODE_URL = "https://example.invalid/api/text-relay/relay_token_here"
CTF_PHONE_NUMBER = "5550100000"
CTF_CARD_NUMBER = "4111111111111111"
CTF_CARD_EXP_MONTH = "02"
CTF_CARD_EXP_YEAR = "2030"
CTF_CARD_CVV = "561"
CTF_ADDRESS_LINE1 = "100 Example Street"
CTF_ADDRESS_LINE2 = "Suite 100"
CTF_CITY = "Exampletown"
CTF_STATE = "CA"
CTF_STATE_NAME = "California"
CTF_POSTAL_CODE = "90001"
...
def parse_sms_pool(raw: str) -> list[dict]:
    ...
    每行格式（来自用户截图）::
        ...
        +15550000001----https://example.invalid/api/text-relay/relay_token_1
        +15550000002----https://example.invalid/api/text-relay/relay_token_2

    返回形如 ``[{"phone": "5550000001", "phone_e164": "+15550000001",
...
def _complete_ctf_sandbox_flow(
    ...
    *,
    ...
    if pool_list:
        ...
        # （默认 +1）。如果直接把 ``15550000001`` 这种含国家码 1 的 11 位号填入，
        # 浏览器会真的输出成 ``+1 15550000001``（12 位） → PayPal 风控会判 phone
        # 校验失败；HAR 实采的 SignUp body 也是 ``"number":"5550000001"`` 这种
